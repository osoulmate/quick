...
class Users(models.Model):
    ...
    token = models.CharField(max_length=50,verbose_name='注册令牌',unique=True)
    token_expire_time = models.CharField(max_length=50,verbose_name='注册令牌过期时间',unique=True)
    reset_token = models.CharField(max_length=50,verbose_name='重置密码令牌',unique=True)
    reset_token_expire_time = models.CharField(max_length=50,default='2999-10-10 10:10:01',verbose_name='重置密码令牌过期时间',unique=True)
