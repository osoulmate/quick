...
unless(defined(&_FEATURES_H)) {
    ...
    if(defined (defined(&_BSD_SOURCE) ? &_BSD_SOURCE : undef)  && !(defined (defined(&_POSIX_SOURCE) ? &_POSIX_SOURCE : undef) || defined (defined(&_POSIX_C_SOURCE) ? &_POSIX_C_SOURCE : undef) || defined (defined(&_XOPEN_SOURCE) ? &_XOPEN_SOURCE : undef) || defined (defined(&_GNU_SOURCE) ? &_GNU_SOURCE : undef) || defined (defined(&_SVID_SOURCE) ? &_SVID_SOURCE : undef))) {
    ...
    if((!defined (defined(&__STRICT_ANSI__) ? &__STRICT_ANSI__ : undef)  && !defined (defined(&_ISOC99_SOURCE) ? &_ISOC99_SOURCE : undef)  && !defined (defined(&_POSIX_SOURCE) ? &_POSIX_SOURCE : undef)  && !defined (defined(&_POSIX_C_SOURCE) ? &_POSIX_C_SOURCE : undef)  && !defined (defined(&_XOPEN_SOURCE) ? &_XOPEN_SOURCE : undef)  && !defined (defined(&_BSD_SOURCE) ? &_BSD_SOURCE : undef)  && !defined (defined(&_SVID_SOURCE) ? &_SVID_SOURCE : undef))) {
	eval 'sub _BSD_SOURCE () {1;}' unless defined(&_BSD_SOURCE);
	eval 'sub _SVID_SOURCE () {1;}' unless defined(&_SVID_SOURCE);
    }
    ...
    eval 'sub __GLIBC_MINOR__ () {12;}' unless defined(&__GLIBC_MINOR__);
